    ...
    <div className="min-h-screen bg-[#0a0a0f] text-white">
      <div className="container mx-auto px-6 py-16 max-w-4xl">
        ...
        <article className="prose prose-custom max-w-none">
          <p className="text-lg text-gray-300">How we use competitor showcases as user research to build features that actually solve recruiting problems, not just look impressive.</p>
