          ...
          <Reveal>
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 bg-white border border-ink-100 shadow-soft rounded-xl flex items-center justify-center">
                <Users className="w-5 h-5 text-ember-600" />
              </div>
              <h1 className="text-3xl md:text-5xl font-semibold tracking-tight text-balance">Contacts & CRM</h1>
            </div>
          </Reveal>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <Reveal>
            <article className="prose prose-custom max-w-none">
              <p className="text-lg text-ink-700">Master the contacts page to manage prospects, candidates, and track all outreach activity in one centralized system.</p>
